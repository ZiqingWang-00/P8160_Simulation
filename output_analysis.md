...
```
    ...
    ##    <fct>   <chr>            <dbl> <chr>  
    ##  1 2       pct_strong_vec  100    forward
    ##  2 2       pct_wai_vec     100    forward
    ##  3 2       pct_wbc_vec     100    forward
    ##  4 2       type1_error_vec  13.0  forward
    ##  5 2       power_vec       100    forward
    ##  6 2       pct_strong_vec   60    forward
    ##  7 2       pct_wai_vec      80    forward
    ##  8 2       pct_wbc_vec     100    forward
    ##  9 2       type1_error_vec   8.70 forward
    ## 10 2       power_vec        76.5  forward
